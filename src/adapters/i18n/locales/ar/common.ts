...
export const common: EnCommonMessages = {
  ...
  "common.pdfPage": "صفحة {page} من ملف PDF",

  "profile.error.chatModelMissing": "اختر ملف نموذج محادثة قبل طرح سؤال.",
  "profile.error.embeddingModelMissing": "اختر ملف نموذج تضمين قبل استخدام هذا الفهرس.",
