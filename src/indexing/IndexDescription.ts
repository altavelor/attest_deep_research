import type { IndexProfile } from "./FileVectorIndexFormat";
import type { LanguageInventoryItem, SourceKind } from "../shared/types";
import { stableId } from "../extractors/common";
import type { IndexDescriptionPromptContext } from "../shared/types";
