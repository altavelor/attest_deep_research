...
export const DownloadDocumentTool = defineTool<DownloadDocumentDeps, DownloadInput, DownloadOutput>(
  {
    ...
    schema: {
      url: str(MAX_URL_CHARS, {
        required: true,
        description: "Absolute http(s) URL of the document.",
      }),
      ...
      overwrite: bool({
        description: "If true, overwrite an existing file at the destination. Default false.",
      }),
    },
