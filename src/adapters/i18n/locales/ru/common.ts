...
export const common: EnCommonMessages = {
  ...
  "profile.warning.indexNotSelected":
    "Выберите проиндексированный профиль в настройках Attest перед поиском.",
  "profile.warning.embeddingProfileUnavailable":
    "Профиль модели эмбеддингов выбранного индекса недоступен. Обновите его в настройках Attest.",
  "profile.warning.embeddingProfileSuspended":
    "Профиль модели эмбеддингов выбранного индекса приостановлен. Обновите его в настройках Attest.",
  "profile.warning.embeddingNotSupported":
    "Модель эмбеддингов выбранного индекса не умеет создавать эмбеддинги. Обновите её в настройках Attest.",
  "profile.warning.embeddingServerUnavailable":
    "Сервер эмбеддингов выбранного индекса недоступен. Обновите его в настройках Attest.",
};
